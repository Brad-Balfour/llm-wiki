...
`wiki-maintenance-cases.json` covers the deterministic boundaries and manual PR
review expectations for inaccessible URLs, duplicate concepts, material updates
