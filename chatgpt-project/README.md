...
`chatgpt-project/WEEKDAY_TLDR_QUEUE_TASK_PROMPT_V3.md` as its candidate managed
prompt. The live v2 body was verified as an exact match on July 26, 2026. The Task remains
