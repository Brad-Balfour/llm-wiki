...
Node 26 is not promoted for this change. Promotion requires a focused GitHub
issue or plan plus matching changes to `package.json`, `.nvmrc`, `.node-version`,
and CI/runtime documentation.
...
deployment-specific configuration unless planned work makes that surface area
part of `llm-wiki`.
