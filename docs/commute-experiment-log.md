...
- The versioned project prompt, schemas, source code, tests,
...
| Jul. 26    | Live configuration audit                                                                       | Compare repository prompts with the signed-in Task and Project and inspect sources, conversations, and failure emails.                                                                                           | Prompt 3.0 is live, all six sources are present, and the Task body exactly matches the committed v2 body. The deployment cutover is verified; only scheduled artifact reliability remains unproven.                                                                                                                                                                                               |
