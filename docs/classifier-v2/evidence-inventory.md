...
| [#66 — Classifier evolution: capture full-candidate diagnostics and build the calibration corpus](https://github.com/Brad-Balfour/llm-wiki/issues/66)         |             8 | 2026-09-04T10:51:12Z | First classifier work: record every article and omission across dates and editions, verify old feedback and versions, and reserve a new final test set. July 28 is one historical omission example. |
...
start and reads the reference only for requested article details. R1 and P10 now
