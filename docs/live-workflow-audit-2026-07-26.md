...
| Home intake 3.x                                | Validation, multi-bundle import, fail-soft feedback/incident persistence, and retryable append-only maintenance outcomes | Remaining fixture coverage                                                                                     | “Reconciliation” means validating supplied session bundles against their queue snapshots, not combining commute conversations or queues. |
